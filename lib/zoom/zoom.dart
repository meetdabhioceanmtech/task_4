...
class _ZoomExampleState extends State<ZoomExample> with SingleTickerProviderStateMixin {
                        ...
                        child: GestureDetector(
                          ...
                          onScaleUpdate: (details) {
                            if (details.pointerCount == 2) {
                              ...
                              double newScale = _imageScales[i] * details.scale;
                              final double imageSize;
                              if (_imageScales[i] < newScale) {
                                imageSize = newSize / _imageScales[i] + _imageScales[i];
                              } else {
                                imageSize = newSize / _imageScales[i] - _imageScales[i];
                              }
                              final double scaleChange = newScale / _imageScales[i];
